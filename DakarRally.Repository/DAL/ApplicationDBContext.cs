    ...
    public class ApplicationDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Vehicle>().HasData(
               ...
               new Vehicle() { Id = 2, ManufacturingDate = DateTime.UtcNow, VehicleModel = "TOYOTA GAZOO RACING	", TeamName = "(QAT) NASSER AL-ATTIYAH", Type = VehicleType.Car.ToString(), SubType = CarType.Sport.ToString(), Speed = 100, RaceId = 1 },
